...
simple_tech_file [required]    | input simple techfile 
    ...
    def fromJson(self, data):
        ...
        # NW configurations
        if 'nw_params' in data: self.nw_params = data["nw_params"]

        # PA configurations
        if 'pa_guide' in data: self.pa_guide = data["pa_guide"]

        # GN configurations
        if 'gn_guide' in data: self.gn_guide = data["gn_guide"]
